            ...
            <div className="row g-0">
              <div className="col-md-4">
               ...
               <div className="col-md-4 offset-md-4">
                  <button className="w-5 align-self-center mt-5"><i className="fa-solid fa-trash-can"></i></button>
                  <button className="w-5 align-self-center mt-5"><i className="fa-solid fa-pencil"></i></button>
                </div>
